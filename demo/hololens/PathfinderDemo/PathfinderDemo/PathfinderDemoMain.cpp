#include "pch.h"
#include "PathfinderDemoMain.h"
#include "Common/DirectXHelper.h"

#include <windows.graphics.directx.direct3d11.interop.h>

using namespace PathfinderDemo;
...
PathfinderDemoMain::PathfinderDemoMain(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded(bind(&PathfinderDemoMain::OnGamepadAdded, this, _1, _2));
    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved(bind(&PathfinderDemoMain::OnGamepadRemoved, this, _1, _2));
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged(bind(&PathfinderDemoMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2));
    }
...
void PathfinderDemoMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
    ...
    m_cameraAddedToken = m_holographicSpace.CameraAdded(std::bind(&PathfinderDemoMain::OnCameraAdded, this, _1, _2));
    ...
    m_cameraRemovedToken = m_holographicSpace.CameraRemoved(std::bind(&PathfinderDemoMain::OnCameraRemoved, this, _1, _2));
...
void PathfinderDemoMain::UnregisterHolographicEventHandlers()
{
...
PathfinderDemoMain::~PathfinderDemoMain()
{
...
HolographicFrame PathfinderDemoMain::Update()
{
...
bool PathfinderDemoMain::Render(HolographicFrame const& holographicFrame)
{
...
void PathfinderDemoMain::SaveAppState()
{
    //
...
void PathfinderDemoMain::LoadAppState()
{
    //
...
void PathfinderDemoMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void PathfinderDemoMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void PathfinderDemoMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void PathfinderDemoMain::OnLocatabilityChanged(SpatialLocator const& sender, winrt::Windows::Foundation::IInspectable const& args)
{
...
void PathfinderDemoMain::OnCameraAdded(
...
void PathfinderDemoMain::OnCameraRemoved(
    HolographicSpace const& sender,
...
void PathfinderDemoMain::OnGamepadAdded(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void PathfinderDemoMain::OnGamepadRemoved(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void PathfinderDemoMain::OnHolographicDisplayIsAvailableChanged(winrt::Windows::Foundation::IInspectable, winrt::Windows::Foundation::IInspectable)
{
    ...
    if (m_spatialLocator != spatialLocator)
    {
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken = m_spatialLocator.LocatabilityChanged(std::bind(&PathfinderDemoMain::OnLocatabilityChanged, this, _1, _2));
